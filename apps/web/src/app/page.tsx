        ...
        <section className="container mx-auto px-4 py-20 lg:py-28">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <h1 className="mb-5 text-5xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-6xl">
                코딩 없이{" "}
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {tools.map((tool) => (
                <Link
                  key={tool.href}
                  href={tool.href}
                  className="group rounded-lg border border-gray-200 bg-white p-5 transition-all hover:border-gray-300 hover:shadow-sm dark:border-gray-800 dark:bg-gray-900 dark:hover:border-gray-700"
                >
                  <tool.icon className="mb-3 h-5 w-5 text-gray-500 dark:text-gray-400" />
                  ...
                  <span className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-purple-600 opacity-0 transition-opacity group-hover:opacity-100 dark:text-purple-400">
            ...
            <div className="grid gap-8 sm:grid-cols-3">
              {steps.map((s, i) => (
                <div key={s.title} className="flex gap-4">
                  <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border-2 border-gray-200 text-sm font-bold text-gray-500 dark:border-gray-700 dark:text-gray-400">
                    {i + 1}
                  </div>
                  <div>
                    <h3 className="mb-1 font-semibold text-gray-900 dark:text-white">
      ...
      <footer className="border-t border-gray-100 dark:border-gray-800">
        <div className="container mx-auto flex items-center justify-between px-4 py-6">
          ...
          <div className="flex gap-4 text-xs text-gray-400 dark:text-gray-500">
            <Link href="/setup" className="hover:text-gray-700 dark:hover:text-gray-300">
              환경 진단
            </Link>
            <Link href="/builder" className="hover:text-gray-700 dark:hover:text-gray-300">
              프롬프트 빌더
            </Link>
            <Link href="/error-translator" className="hover:text-gray-700 dark:hover:text-gray-300">
              에러 번역기
            </Link>
            <Link href="/glossary" className="hover:text-gray-700 dark:hover:text-gray-300">
              용어 사전
            </Link>
          </div>
        </div>
